...
def test_multiple_triggers_for_single_function(
    ...
    assert (
        result["/page-url/_event/dummy-button/click"] == function_definitions_multiple_triggers
    )

    assert "/page-url/_event/dummy-input/input" in result
    assert result["/page-url/_event/dummy-input/input"] == function_definitions_multiple_triggers
